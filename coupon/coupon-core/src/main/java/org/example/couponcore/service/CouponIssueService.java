...
public class CouponIssueService {
    ...
    private void publishCouponEvent(Coupon coupon) {
        if (coupon.isIssueCompleted()) {
            CouponIssueCompleteEvent couponIssueCompleteEvent = new CouponIssueCompleteEvent(coupon.getId());
            applicationEventPublisher.publishEvent(couponIssueCompleteEvent);
        }
    }
}
